...
- Made the dedicated `Power Word: Shield` path override-aware so it can follow active shield variants like `Void Shield` instead of only tracking the base spell ID.
