...
- Moved Discipline `Power Word: Shield` onto a dedicated cooldown-only readiness path so its icon no longer reacts to target/mouseover state and can recover from combat cooldown transitions more consistently.
